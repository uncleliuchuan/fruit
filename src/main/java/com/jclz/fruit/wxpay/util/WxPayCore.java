...
public class WxPayCore {
    ...
    public static SortedMap<Object, Object> createWxPayParamForRefund(String out_trade_no, String out_refund_no, Integer refund_fee) {
        //声明统一下单待签名字符串的map
        SortedMap<Object, Object> wxparameters = new TreeMap<Object, Object>();
        ...
        wxparameters.put("total_fee", refund_fee);//订单金额
