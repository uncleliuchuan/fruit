...
public class YouMengUtil {
   ...
   /* public YouMengUtil(String key,String secret){
    ...
    public static void sendAndroidUnicast() throws Exception {
        ...
        unicast.setDeviceToken("AuphYwCTJoatAtEjeVB9yV5ya0CmrawxJrnbcos1nkd2");
    ...
    public static boolean sendAndroidCustomizedcast(Integer receivedId, String content, String type) throws Exception {
        ...
        object.put("messageTitle", "超级果蔬提示");
        ...
        customizedcast.setTitle("超级果蔬·推送");
        customizedcast.setText(content);
        customizedcast.goAppAfterOpen();
        //额外参数
        customizedcast.setExtraField("type", "3");
        customizedcast.setExtraField("content", "test");
        //TODO
